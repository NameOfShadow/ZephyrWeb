            ...
            <div className="w-full max-w-md space-y-8">
                ...
                <div className="flex flex-col items-center gap-4">
                    <div className="flex items-center gap-3 group">
                        <div className="p-3 rounded-xl bg-indigo-600/20 backdrop-blur-sm border border-indigo-500/30 transition-all group-hover:bg-indigo-600/30">
              ...
              Zephyr Inc.
                ...
                {/* Форма */}
                <div className="bg-slate-800/70 backdrop-blur-lg rounded-2xl p-8 shadow-2xl border border-slate-700/50 transition-all hover:border-slate-600/50">
